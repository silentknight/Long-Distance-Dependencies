...
class Corpus(object):
	...
	def choose_dataset(self):
		...
		self.train = self.tokenize_file(os.path.join(path, 'train.txt'), 1)
		self.valid = self.tokenize_file(os.path.join(path, 'valid.txt'), 0)
		self.test = self.tokenize_file(os.path.join(path, 'test.txt'), 0)
