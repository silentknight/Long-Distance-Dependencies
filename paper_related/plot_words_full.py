...
filenames = ["penn_tree", "wiki2", "wiki103", "text8", "text8_subset", "text8_subset_wor", "wiki_sample_1", "wiki_sample_2", "wiki_sample_3", "wiki_sample_4"]
...
for filename in filenames:
    f = open(filename+"_words_full_grassberger_logx_mi.dat", "r")
    lines = f.readlines()
    f.close()
