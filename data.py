...
class Corpus(object):
	...
	def choose_dataset(self, path):
		if path == "dataset/dl4mt/":
			...
			print("foma dataset")
			self.text = self.tokenize_file(os.path.join(path, 'Data_SP2_20_New_F2.dat'))
		...
		elif path == "dataset/cifar10/red":
			print("CIFAR 10 Dataset, Red channel")
			self.process_cifar_10(red)

		elif path == "dataset/cifar10/green":
			print("CIFAR 10 Dataset, Green channel")
			self.process_cifar_10(green)

		elif path == "dataset/cifar10/blue":
			print("CIFAR 10 Dataset, Blue channel")
			self.process_cifar_10(blue)

		elif path == "dataset/cifar10/gray":
			print("CIFAR 10 Dataset, Grayscale channel")
			self.process_cifar_10(gray)
...
def process_cifar_10(channel):
    ...
    for i in range(data.shape[0]):
        ...
        self.tokenize_strings(pixel_line)